...
import { Home, MessageCircle, Rocket, Trophy, PlusCircle, Sparkles } from 'lucide-react'
...
const navItems: NavItem[] = [
  ...
  { label: 'Questions', href: '/questions', icon: MessageCircle, badge: 12 },
      ...
      >
        ...
        <div className="p-6 border-t border-white/10">
          ...
          <div className="mt-4 space-y-2">
            ...
            >
              <span>Drafts</span>
              <span className="ml-auto text-xs bg-white/10 px-2 py-0.5 rounded-full">3</span>
            </Link>
            <Link
              href="/bookmarks"
              className="
        ...
        <div className="p-6 border-t border-white/10">
          ...
          ">
            <div className="flex items-center gap-3 mb-3">
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-violet-500 to-emerald-500" />
              <div className="flex-1 min-w-0">
                <p className="text-sm font-semibold text-clay-white truncate">Guest User</p>
                <p className="text-xs text-clay-white/50">Level 1</p>
              </div>
            </div>
            <div className="space-y-1.5">
              <div className="flex justify-between text-xs">
                <span className="text-clay-white/50">Progress</span>
                <span className="text-clay-white font-medium">15%</span>
              </div>
