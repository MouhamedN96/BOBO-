...
import { Flame, Zap, MessageCircle, Share2, Copy, Check, ChevronDown } from 'lucide-react'
...
export const ImpactCard: React.FC<ImpactCardProps> = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        'p-4 rounded-xl bg-gradient-to-br from-charcoal-base/80 to-charcoal-base/40 border border-savanna-gold/20',
        'backdrop-blur-sm',
        className
      )}
    >
      ...
      <div className="mb-4">
        <div className="flex items-center gap-2 mb-1">
          <h3 className="text-sm font-heading font-bold text-clay-white">YOUR IMPACT</h3>
